...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_myAccount_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_myAccount_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_myAccount_2eproto = nullptr;

const uint32_t TableStruct_myAccount_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_myAccount_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017myAccount.proto\022\002IM\"5\n\007Account\022\n\n\002ID\030\001"
  " \001(\004\022\014\n\004name\030\002 \001(\t\022\020\n\010password\030\003 \001(\t\"!\n\004"
  "User\022\031\n\004user\030\001 \001(\0132\013.IM.Accountb\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_myAccount_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_myAccount_2eproto = {
  false, false, 119, descriptor_table_protodef_myAccount_2eproto, "myAccount.proto", 
  &descriptor_table_myAccount_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_myAccount_2eproto::offsets,
  file_level_metadata_myAccount_2eproto, file_level_enum_descriptors_myAccount_2eproto, file_level_service_descriptors_myAccount_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_myAccount_2eproto_getter() {
  return &descriptor_table_myAccount_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_myAccount_2eproto(&descriptor_table_myAccount_2eproto);
namespace IM {
...
::PROTOBUF_NAMESPACE_ID::Metadata Account::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_myAccount_2eproto_getter, &descriptor_table_myAccount_2eproto_once,
      file_level_metadata_myAccount_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata User::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_myAccount_2eproto_getter, &descriptor_table_myAccount_2eproto_once,
      file_level_metadata_myAccount_2eproto[1]);
}
